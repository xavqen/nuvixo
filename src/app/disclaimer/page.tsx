  ...
  return (
    <MainLayout>
      <div className="container py-16 max-w-3xl mx-auto prose dark:prose-invert">
        <h1>Disclaimer</h1>
        <p>Studiya is an independent educational platform and is not affiliated with, endorsed by, or officially connected to NCERT (National Council of Educational Research and Training) or CBSE (Central Board of Secondary Education).</p>
        ...
        <p>Studiya does not guarantee specific exam scores or outcomes. Results depend on individual effort, understanding, and additional practice.</p>
