  ...
  return (
    <MainLayout>
      <div className="container py-16 max-w-3xl mx-auto prose dark:prose-invert">
        <h1>DMCA Policy</h1>
        <p>Studiya respects the intellectual property rights of others. All notes on our platform are either originally created by our team or licensed appropriately.</p>

        <h2>Filing a DMCA Complaint</h2>
        <p>If you believe content on Studiya infringes your copyright, send a written notice to hello@studiya.com including:</p>
        <ul>
